        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border px-4 py-3 hover:border-blue-600 rounded-lg duration-200" +
        ...
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 px-4 border hover:border-blue-600 py-3 rounded-lg duration-200" +
